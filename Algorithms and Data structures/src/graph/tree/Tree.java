...
public class Tree<E extends Edge, V extends Vertex<E>> extends BiGraph<E,V>{
	...
	/**
	 * oblicza srednice drzewa dwoma bfsami:
	 * 1) wyznaczenie najdalszego wierzchołka V od 0
	 * 2) wyznaczenie najdalszego wierzchołka U od V
	 *  
	 * @return srednica drzewa czyli liczba wierzcholkow od V do U wlacznie 
	 */
	public int diameter(){
		int d = 0;
